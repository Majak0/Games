...
/**
 * Codes ISO des entités présentes sur la carte @svg-maps/world.
 * Généré à partir de l'intersection carte + base (après complétion du seeder).
 */
return [
    ...
    'gb', 'gd', 'ge', 'gf', 'gg', 'gh', 'gi', 'gl', 'gm', 'gn', 'go', 'gp', 'gq', 'gr', 'gs',
    ...
    'tr', 'tt', 'tv', 'tw', 'tz', 'ua', 'ug', 'um-dq', 'um-fq', 'um-hq', 'um-jq', 'um-mq', 'um-wq',
